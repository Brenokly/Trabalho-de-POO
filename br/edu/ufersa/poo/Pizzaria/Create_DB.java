...
public class Create_DB {
    public static void main(String[] args) {
        ...
        try {
            ...
            String createTables = "CREATE TABLE IF NOT EXISTS tb_user (" +
                    ...
                    "CREATE TABLE IF NOT EXISTS tb_pedido_log (" +
            ...
            String createView = "CREATE OR REPLACE VIEW vw_itenspedido AS " +
                    "SELECT " +
                    "p.id AS id_pedido, " +
                    "p.id_cliente, " +
                    "p.estado, " +
            ...
            String createFuncions = "CREATE OR REPLACE FUNCTION log_pedido_estado() " +
                    "RETURNS TRIGGER AS $$ " +
                    "BEGIN " +
                    "INSERT INTO tb_pedido_log (pedido_id, data_hora, novo_estado) " +
                    "VALUES (OLD.id, CURRENT_TIMESTAMP, NEW.estado); " +
                    "RETURN NEW; " +
                    "END; " +
                    "$$ LANGUAGE plpgsql; ";

            String createTriggers = "CREATE TRIGGER trigger_log_pedido_estado " +
            ...
            statement.executeUpdate(createFuncions);
            statement.executeUpdate(createTriggers);
